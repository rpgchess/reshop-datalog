var system = {
    ...
    create: function() {
        ...
        arrTemp = String(this.ws.ExpandEnvironmentStrings(this.enum.APP_DATA + ',' + this.enum.PROGRAM_FILES + ',' + this.enum.TEMP + ',' + this.enum.USER_NAME + ',' + this.enum.USER_PROFILE + ',' + this.enum.WIN_DIR + ',' + this.enum.SYSTEM_DRIVE)).split(',');
